...
def get_arg_parser():
    ...
    parser.add_argument('--color', default=100, type=int, help="Color of poisoning", dest="color")
    parser.add_argument('--poison_method', default='None', type=str, help="Which poison method will be used", dest="poison_method")
    ...
    parser.add_argument('--every_some', default=0, type=int, help="poison 1 out of every_some * emulator_counts states", dest="every_some")
    ...
    parser.add_argument('--trajectories_to_poison', default=-1, type=int, help="Number of trajectories to poison at each iteration", dest="tr_to_poison")
    parser.add_argument('--moving', default=False, type=bool_arg, help="whether the poison pattern will change position", dest="moving")
    parser.add_argument('--poison_steps', default=-1, type=int, help="how many states will be poisoned", dest="poison_steps")
